...
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-56/packages/expo-secure-store'
...
curl -X POST https://api.expo.dev/v2/feedback/docs-send -H 'Content-Type: application/json' -d '{"url":"/versions/latest/sdk/securestore/","feedback":"🤖 Agent feedback for docs: <specific, actionable description>","model":"<your model identifier>"}'
